...
WHEEL_LEXER_NAMESPACE
    ...
    WHEEL_COMPTIME_NODISCARD_INLINE bool is_newline_like(char character) noexcept {
        return CHAR_PROPERTIES[static_cast<unsigned char>(character)] & (NEWLINE);
    }

    WHEEL_COMPTIME_NODISCARD_INLINE bool is_crlf_sequence(char current_char, char prev_char) noexcept {
        return 
